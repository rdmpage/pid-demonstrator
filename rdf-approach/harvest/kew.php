...
$rdf_filename = dirname(__FILE__) . '/kew.nt';
...
foreach ($ids as $id)
{
	...
	$url = 'http://specimens.kew.org/herbarium/' . $id;
	...
	// fix broken RDF
	$rdf = str_replace("</rdf:Description>\n<!-- Image associated with the specimen -->", "<!-- Image associated with the specimen -->", $rdf);
	$rdf = str_replace("</rdf:RDF>", "</rdf:Description>\n</rdf:RDF>", $rdf);
